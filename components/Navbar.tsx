    ...
    <>
      ...
      <header className="fixed top-1 z-50 w-full glass-header">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
          <Link href="/" className="flex flex-col items-center justify-center group relative mt-2">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-forest tracking-wide">
            ...
            <Link className="hover:text-saffron transition-colors uppercase" href="/journal">The Journal</Link>
          </nav>
          <div className="flex items-center gap-4">
            <Link href="/consultation" className="hidden sm:flex bg-saffron text-white px-5 py-2 rounded-full font-bold text-sm tracking-wide hover:bg-forest transition-colors">
              CONSULT NOW
            </Link>
            <Link href="/checkout" className="p-2 hover:bg-forest/10 rounded-full transition-colors relative text-forest">
