...
const DailyDew: React.FC = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 transition-colors duration-300">
            {/* Top Navigation Bar */}
            <header className="sticky top-0 z-50 w-full border-b border-brand-green/10 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md px-6 lg:px-20 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="text-brand-green dark:text-brand-saffron">
                        <span className="material-symbols-outlined text-3xl">fluid</span>
                    </div>
                    <h2 className="text-brand-green dark:text-slate-100 text-xl font-bold tracking-tight">Jammi Pharmaceuticals</h2>
                </div>
                <nav className="hidden md:flex gap-8 items-center text-sm font-semibold uppercase tracking-wider text-brand-green/80 dark:text-slate-300">
                ...
                <div className="flex items-center gap-4">
                    <button className="p-2 rounded-full hover:bg-brand-green/5 dark:hover:bg-white/5 transition-colors">
                        <span className="material-symbols-outlined">search</span>
                    </button>
                    <button className="p-2 rounded-full hover:bg-brand-green/5 dark:hover:bg-white/5 transition-colors">
                        <span className="material-symbols-outlined">favorite</span>
                    </button>
                    <button className="relative p-2 rounded-full bg-brand-green text-white dark:bg-brand-saffron">
            ...
            <main className="max-w-7xl mx-auto px-6 py-10 lg:py-16">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-4">
                        <div className="aspect-square bg-brand-cream dark:bg-slate-800 rounded-2xl overflow-hidden flex items-center justify-center border border-brand-green/5">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            ...
                            <div class="aspect-square rounded-xl overflow-hidden bg-brand-cream">
                            ...
                            <div className="aspect-square rounded-xl overflow-hidden bg-brand-cream flex items-center justify-center">
                                <span className="material-symbols-outlined text-brand-green/40">play_circle</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-black text-brand-green dark:text-slate-100 leading-tight">Daily Dew Moisturizer</h1>
                            <p className="text-lg text-brand-green/70 dark:text-slate-400 mt-2 italic font-medium">Heritage-Rich Ayurvedic Formula for Golden Glow</p>
                        </div>
                        ...
                        {/* Key Benefits */}
                        <div className="grid grid-cols-3 gap-4 py-4 border-y border-brand-green/10">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4">
                                ...
                                <button className="flex-1 bg-brand-green dark:bg-primary text-white font-bold py-4 rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2">
                            ...
                            <div className="flex items-center justify-center gap-6 py-2">
                                <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
                                    <span className="material-symbols-outlined text-brand-green">verified_user</span> 100% Authentic
                                </div>
                                <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
                                    <span className="material-symbols-outlined text-brand-green">local_shipping</span> Free Shipping
                                </div>
                                <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
                                    <span className="material-symbols-outlined text-brand-green">psychology</span> Dermatologist Tested
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-20 space-y-20">
                    {/* Ingredients Section */}
                    <section className="bg-brand-cream/50 dark:bg-slate-900/50 rounded-3xl p-8 lg:p-16 border border-brand-green/5">
                        <div className="max-w-3xl mx-auto text-center mb-12">
                            <h2 className="text-3xl font-bold text-brand-green dark:text-brand-saffron">Ancient Wisdom, Modern Science</h2>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-brand-green/5 hover:border-brand-saffron transition-colors">
                    ...
                    <section className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 space-y-8">
                            <h2 className="text-4xl font-bold text-brand-green dark:text-slate-100">Ritual for Radiance</h2>
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-brand-green text-white flex items-center justify-center font-bold">1</span>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-brand-green text-white flex items-center justify-center font-bold">2</span>
                                    <div>
                                ...
                                <div className="flex gap-4">
                                    <span className="flex-shrink-0 w-10 h-10 rounded-full bg-brand-green text-white flex items-center justify-center font-bold">3</span>
                                    <div>
                    ...
                    <section className="grid lg:grid-cols-2 gap-16">
                            ...
                            <div className="space-y-4">
                                <details className="group border-b border-slate-200 dark:border-slate-800 pb-4" open>
                                    <summary className="flex items-center justify-between cursor-pointer list-none">
                                        <span className="font-bold text-brand-green dark:text-slate-200">Is it suitable for oily skin?</span>
                                ...
                                <details className="group border-b border-slate-200 dark:border-slate-800 pb-4">
                                    <summary className="flex items-center justify-between cursor-pointer list-none">
                                        <span className="font-bold text-brand-green dark:text-slate-200">Can I use it under makeup?</span>
                                        <span className="material-symbols-outlined transition-transform group-open:rotate-180">expand_more</span>
                                    </summary>
                                ...
                                <details className="group border-b border-slate-200 dark:border-slate-800 pb-4">
                                    <summary className="flex items-center justify-between cursor-pointer list-none">
                                        <span className="font-bold text-brand-green dark:text-slate-200">Are there any synthetic fragrances?</span>
                                        <span className="material-symbols-outlined transition-transform group-open:rotate-180">expand_more</span>
                                    </summary>
                        ...
                        {/* Reviews Summary */}
                        <div className="bg-brand-green/5 dark:bg-white/5 p-8 rounded-3xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <button className="w-full text-center text-sm font-bold text-brand-green underline tracking-widest uppercase">View All 128 Reviews</button>
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <footer className="bg-brand-green dark:bg-slate-950 text-white py-16 px-6 mt-20">
