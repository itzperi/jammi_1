            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-['Playfair_Display',serif] font-bold text-[#2E5339] dark:text-[#D4882E] mb-2">Hepableen Syrup</h1>
                        ...
                        <div className="space-y-6 mb-10">
                            <p className="text-[#2E5339]/70 leading-relaxed">
                                A potent Ayurvedic formulation designed to support systemic wellness and liver function, formulated in an easily absorbed syrup.
                            </p>
                            <div className="flex items-center gap-4">
