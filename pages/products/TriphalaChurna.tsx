                ...
                <section className="grid grid-cols-1 md:grid-cols-10 gap-12 mb-20">
                    ...
                    <div className="md:col-span-4 flex flex-col">
                        ...
                        <nav className="text-xs text-gray-500 mb-4 flex space-x-2 uppercase tracking-widest">
                            <Link to="/" className="hover:text-[#2E5339]">Home</Link>
                            <span>/</span>
                            <Link to="/shop" className="hover:text-[#2E5339]">Wellness</Link>
                            <span>/</span>
                ...
                <section className="mb-20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <div className="bg-white p-4 rounded-[14px] custom-shadow group cursor-pointer relative block">
                            <Link to="/product/ashwagandha" className="absolute inset-0 z-10 block opacity-0">View Product</Link>
                            ...
                            <div className="flex justify-between items-center relative z-20">
                                ...
                                <Link to="/product/ashwagandha" className="text-[#2E5339] text-xs font-bold uppercase tracking-widest border-b-2 border-[#2E5339] hover:text-[#1A2E20] hover:border-[#1A2E20] transition">
                                    View Product
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-4 rounded-[14px] custom-shadow group cursor-pointer relative block opacity-70">
                            <Link to="/product/brahmi" className="absolute inset-0 z-10 block opacity-0">View Product</Link>
                            <div className="aspect-square bg-[#FAF6F0] rounded-lg mb-4 overflow-hidden p-4">
                                <img
                                    alt="Brahmi"
                            ...
                            <div className="flex justify-between items-center relative z-20">
                                ...
                                <Link to="/product/brahmi" className="text-[#2E5339] text-xs font-bold uppercase tracking-widest border-b-2 border-[#2E5339] hover:text-[#1A2E20] hover:border-[#1A2E20] transition">
                                    View Product
                                </Link>
                            </div>
                        </div>
