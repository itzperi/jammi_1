            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24 items-start">
                    <div className="lg:col-span-12">
                        <nav className="text-[10px] font-bold text-slate-400 mb-8 flex space-x-2 uppercase tracking-widest">
                            ...
                            <span>/</span>
                            <span className="text-brand-red font-bold underline decoration-brand-red/20 underline-offset-4 tracking-widest uppercase">Triphala Churna</span>
                        </nav>
                    </div>
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-8">
                        <div className="relative bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden p-12 group">
                            ...
                            <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full border border-brand-red/10 shadow-sm">
                                <span className="text-[10px] font-bold text-brand-red font-subheading tracking-widest uppercase">Universal Tonic</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-12 lg:row-start-2 lg:col-span-5 flex flex-col gap-10 mt-[-30rem] lg:mt-0 lg:absolute lg:right-0 lg:w-[40%]">
                        {/* Maintenance of grid consistency */}
                    </div>

                    <div className="lg:col-span-5 flex flex-col gap-10">
                        <div>
                            <h1 className="font-heading text-6xl text-brand-red mb-4 uppercase tracking-tighter">Triphala</h1>
                            <p className="font-subheading text-lg text-charcoal/60 italic mb-8 italic">The Ultimate Three-Fruit Detox & Digestive Harmonizer</p>

                            <div className="flex items-center gap-6 py-8 border-y border-slate-100">
                                <div className="flex flex-col">
                                    <span className="text-4xl font-bold text-brand-red tracking-tight">₹180</span>
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">100g Ancient Botanical Powder</span>
                                </div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Vedic Gold</span>
                                </div>
                            </div>
                        </div>

                        <div className="space-y-6">
                            <p className="text-charcoal/70 leading-relaxed font-body">Triphala Churna is Ayurveda's most revered tonic for longevity. A balanced blend of Amalaki, Bibhitaki, and Haritaki, it acts as a gentle internal cleanser, supporting digestive regularity while nourishing the eyes and boosting systemic immunity.</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { icon: 'cleaning_services', text: 'Gentle Detox' },
                                { icon: 'visibility', text: 'Eye Health' },
                                { icon: 'shield_moon', text: 'Immune Support' },
                                { icon: 'verified', text: 'Tridoshic Balance' }
                            ].map((feat, i) => (
                ...
                <section className="bg-slate-50/50 rounded-3xl p-12 md:p-24 mb-24 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="font-heading text-4xl text-brand-red mb-6 uppercase tracking-tight">The Three Cosmic Fruits</h2>
                            <p className="text-charcoal/70 leading-relaxed font-body mb-8 italic">"Triphala is unique because it balances all three Doshas. It is the only cleanser that does not deplete the body. In fact, it is a 'Rasayana'—a rejuvenator that builds vitality while clearing the path for healing."</p>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Vitamin C Rich Amalaki</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Laxative Haritaki</span>
                                </div>
                            </div>
                        </div>
                        <div className="aspect-video bg-white rounded-2xl shadow-xl flex items-center justify-center border border-slate-100">
                            <div className="text-center group">
                                <span className="block text-5xl font-heading font-bold text-brand-red group-hover:scale-110 transition-transform">95%</span>
                                <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Reported Better Regularity</span>
                            </div>
                        </div>
                    </div>
                </section>

                <ReviewSystem productId="triphala-churna" />
                <SmartRecommendations currentId="triphala-churna" />
            </main>
        </div>
    );
};
