            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24 items-start">
                    <div className="lg:col-span-12">
                        <nav className="text-[10px] font-bold text-slate-400 mb-8 flex space-x-2 uppercase tracking-widest">
                            ...
                            <span>/</span>
                            <span className="text-brand-red font-bold underline decoration-brand-red/20 underline-offset-4 tracking-widest uppercase">Trip Caps</span>
                        </nav>
                    </div>
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-8">
                        <div className="relative bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden p-12 group">
                            ...
                            <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full border border-brand-red/10 shadow-sm">
                                <span className="text-[10px] font-bold text-brand-red font-subheading tracking-widest uppercase">Digestive Flow</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-10">
                        <div>
                            <h1 className="font-heading text-6xl text-brand-red mb-4 uppercase tracking-tighter">Trip Caps</h1>
                            <p className="font-subheading text-lg text-charcoal/60 italic mb-8 italic">Gentle Overnight Relief & Systemic Digestive Harmony</p>
                            ...
                            <div className="flex items-center gap-6 py-8 border-y border-slate-100">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">30 High-Potency Botanical Capsules</span>
                                </div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Daily Support</span>
                                </div>
                            </div>
                        </div>

                        <div className="space-y-6">
                            <p className="text-charcoal/70 leading-relaxed font-body">Trip Caps is a specialized Ayurvedic laxative designed for those who seek reliability without the harshness. Formulated with Ajwain and Senna, it works with your body's natural circadian rhythm to provide a smooth, predictable morning clearance while pacifying 'Vata' in the colon.</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { icon: 'auto_awesome', text: 'Gentle Relief' },
                                { icon: 'eco', text: 'Non-Habit Forming' },
                                { icon: 'bolt', text: 'Overnight Action' },
                                { icon: 'verified', text: 'Natural Purity' }
                            ].map((feat, i) => (
                ...
                <section className="bg-slate-50/50 rounded-3xl p-12 md:p-24 mb-24 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="font-heading text-4xl text-brand-red mb-6 uppercase tracking-tight">The Science of Movement</h2>
                            <p className="text-charcoal/70 leading-relaxed font-body mb-8 italic">"Digestive ease is the secret to systemic vitality. Trip Caps uses the 'Usna' (penetrating) property of Ajwain to break down metabolic waste ('Ama'), while Haritaki ensures its smooth expulsion, keeping the internal channels clear and vibrant."</p>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Pro-Kinetic Botanicals</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Balances Colon Function</span>
                                </div>
                            </div>
                        </div>
                        <div className="aspect-video bg-white rounded-2xl shadow-xl flex items-center justify-center border border-slate-100">
                            <div className="text-center group">
                                ...
                                <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Reported Smooth Mornings</span>
                            </div>
                        </div>
                    </div>
                </section>

                <ReviewSystem productId="trip-caps" />
                <SmartRecommendations currentId="trip-caps" />
            </main>
        </div>
    );
};
