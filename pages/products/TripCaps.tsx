                    ...
                    <div className="lg:col-span-6 space-y-4">
                        <nav className="text-xs text-gray-500 mb-4" data-purpose="breadcrumbs">
                            <ol className="flex space-x-2">
                                <li><Link className="hover:text-[#2E5339]" to="/">Home</Link></li>
                                <li><span>/</span></li>
                                <li><Link className="hover:text-[#2E5339]" to="/shop">Therapeutics</Link></li>
                                <li><span>/</span></li>
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                <button className="flex-1 py-3 px-4 border-2 border-[#2E5339] rounded-lg text-sm font-medium text-[#2E5339] bg-green-50">10 x 10 Pack</button>
