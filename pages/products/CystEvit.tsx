    ...
    <div className="bg-background-light text-slate-900 font-sans">
      <main className="max-w-7xl mx-auto px-6 lg:px-20 py-10 lg:py-16">
        <nav className="flex items-center gap-2 text-xs uppercase tracking-widest text-heritage-dark/50 mb-8">
          ...
          <span className="material-symbols-outlined text-[10px]">chevron_right</span>
          <span className="text-primary font-bold">Cyst Evit</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div className="aspect-[4/5] bg-heritage-soft rounded-xl overflow-hidden shadow-2xl">
            <img 
              ...
              src="https://picsum.photos/seed/cystevit/600/800"
            />
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div>
              <div className="flex items-center gap-2 text-primary mb-3">
                ...
                <span className="text-xs font-bold uppercase tracking-tighter">Women's Health</span>
              </div>
              ...
              <p className="text-lg text-heritage-dark/70 font-light leading-relaxed">
                Natural support for hormonal balance and reproductive wellness. Formulated with potent Ayurvedic herbs to support women's health through every stage of life.
              </p>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-3xl font-serif font-bold text-primary">₹550.00</span>
            </div>
