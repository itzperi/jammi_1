                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-7 flex flex-col pt-2">
                                <div className="mb-6 border-b border-slate-200 dark:border-slate-800 pb-6">
                                    ...
                                    <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight mb-4">Cyst Evit</h1>
                                ...
                                <div className="flex items-end gap-6 mb-8">
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-baseline gap-2">
                                            ...
                                            <span className="text-sm font-bold text-green-600 bg-green-100 dark:bg-green-900/30 px-2 py-0.5 rounded">Save 22%</span>
                                        </div>
                                    </div>
                                </div>
