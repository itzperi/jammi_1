            ...
            <main className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 py-10 pt-24" id="main-content">
                ...
                <nav aria-label="Breadcrumb" className="mb-12">
                    <ol className="flex items-center space-x-3 text-sm font-medium tracking-wider uppercase">
                        <li><Link to="/" className="text-gray-400 hover:text-[#D4882E] transition-colors focus:outline-none focus:ring-2 focus:ring-[#D4882E] rounded px-1 -ml-1">Home</Link></li>
                        <li><span aria-hidden="true" className="text-gray-300">/</span></li>
                        <li><Link to="/shop" className="text-gray-400 hover:text-[#D4882E] transition-colors focus:outline-none focus:ring-2 focus:ring-[#D4882E] rounded px-1">Endocrine Health</Link></li>
                        <li><span aria-hidden="true" className="text-gray-300">/</span></li>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <label className="relative cursor-pointer group">
                                        ...
                                        <div className="p-4 border-2 border-gray-200 rounded-xl peer-checked:border-[#2E5339] peer-checked:bg-[#2E5339]/5 transition-all text-center h-full flex flex-col justify-center relative overflow-hidden">
                                            ...
                                            <div className="absolute inset-0 bg-green-500/10 scale-0 peer-checked:scale-100 transition-transform duration-300 rounded-lg -z-10 origin-bottom"></div>
                                            ...
                                            <span className="block text-xs text-green-600 font-bold mt-1">Extra 10% Off</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
