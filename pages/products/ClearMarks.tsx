                        ...
                        <div className="mt-auto p-6 rounded-3xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                            <div className="flex items-end justify-between mb-6">
                                ...
                                <div className="flex items-center bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 px-3 py-1">
                                    <button className="p-2 text-slate-400 hover:text-primary transition-colors"><span class="material-symbols-outlined text-sm">remove</span></button>
                                    <span className="px-4 font-bold">1</span>
                                    <button className="p-2 text-slate-400 hover:text-primary transition-colors"><span class="material-symbols-outlined text-sm">add</span></button>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button className="bg-primary p-2 text-white rounded-xl"><span class="material-symbols-outlined">send</span></button>
                            </div>
                        </div>
                    </div>
