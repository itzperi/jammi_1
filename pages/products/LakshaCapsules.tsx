            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24 items-start">
                    <div className="lg:col-span-12">
                        <nav className="text-[10px] font-bold text-slate-400 mb-8 flex space-x-2 uppercase tracking-widest">
                            ...
                            <span>/</span>
                            <span className="text-brand-red font-bold underline decoration-brand-red/20 underline-offset-4 tracking-widest uppercase">Laksha Capsules</span>
                        </nav>
                    </div>
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-8">
                        <div className="relative bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden p-12 group">
                            ...
                            <div className="absolute top-8 left-8 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full border border-brand-red/10 shadow-sm">
                                <span className="text-[10px] font-bold text-brand-red font-subheading tracking-widest uppercase">Structural Recovery</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-10">
                        <div>
                            <h1 className="font-heading text-6xl text-brand-red mb-4 uppercase tracking-tighter">Laksha</h1>
                            <p className="font-subheading text-lg text-charcoal/60 italic mb-8 italic">Advanced Bone Healing & Mineral Density Support</p>
                            ...
                            <div className="flex items-center gap-6 py-8 border-y border-slate-100">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Bone-Targeted Shastric Capsules</span>
                                </div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Clinical Purity</span>
                                </div>
                            </div>
                        </div>

                        <div className="space-y-6">
                            <p className="text-charcoal/70 leading-relaxed font-body">Laksha Capsules are a specialized natural formula designed to accelerate bone healing and significantly improve bone mineral density. By promoting osteoblast differentiation, it provides the vital minerals needed for deep structural restoration.</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                { icon: 'healing', text: 'Fracture Healing' },
                                { icon: 'fitness_center', text: 'Enhanced Density' },
                                { icon: 'spa', text: 'Bone Nourishment' },
                                { icon: 'verified', text: 'Vedic Actives' }
                            ].map((feat, i) => (
                ...
                <section className="bg-slate-50/50 rounded-3xl p-12 md:p-24 mb-24 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="font-heading text-4xl text-brand-red mb-6 uppercase tracking-tight">The Osteo-Restorative Wisdom</h2>
                            <p className="text-charcoal/70 leading-relaxed font-body mb-8 italic">"Laksha is more than a mineral supplement; it is a catalyst. In the Ayurvedic tradition, it is the premier substance for 'Sandhana'—the unification of tissues, particularly effective for bone restoration."</p>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Purified Laksha Resin</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-1.5 h-1.5 rounded-full bg-warm-gold"></div>
                                    <span className="text-xs font-bold text-brand-red uppercase tracking-widest">Bone-Binding Asthishrinkhala</span>
                                </div>
                            </div>
                        </div>
                        <div className="aspect-video bg-white rounded-2xl shadow-xl flex items-center justify-center border border-slate-100">
                            <div className="text-center group">
                                ...
                                <span className="text-[10px] font-bold text-charcoal/40 uppercase tracking-widest">Reported Faster Recovery Times</span>
                            </div>
                        </div>
                    </div>
                </section>

                <ReviewSystem productId="laksha-capsules" />
                <SmartRecommendations currentId="laksha-capsules" />
            </main>
        </div>
    );
};
