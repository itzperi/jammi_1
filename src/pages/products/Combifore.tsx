                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="flex items-end gap-6 mb-10 pb-10 border-b border-slate-200 dark:border-slate-800">
                            ...
                            <div className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 py-1 rounded-lg text-sm font-bold flex items-center gap-1 h-fit mb-2 border border-green-200 dark:border-green-800/50">
